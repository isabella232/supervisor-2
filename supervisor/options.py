...
class ClientOptions(Options):
    ...
    def __init__(self):
        ...
        self.configroot.supervisorctl.suppress_exit = None
        ...
        self.add("suppress_exit", "supervisorctl.suppress_exit", "e",
                 "suppress_exit", flag=1, default=0)
